...
1. Folks who took Elements I with Prof. Walden have gotten to use a few different Python IDEs, specifically [Replit](https://repl.it/) and Jupyter Notebooks (and possibly Google CoLab).
...
6. A browser based IDE like Replit (generally) worked for (most of) our needs. But it ran into problems with more complex programs or programs involving external files/datasets/etc. Similarly, Jupyter notebooks is well-suited to some tasks or types of programs, but less useful for others.

7. In this lab, we're going to work with another Python IDE, Spyder, that is available as a stand-alone program and through Anaconda.
...
10. In this lab, we'll be using the Spyder program within Anaconda.
...
To install Spyder as a stand-alone program:
...
- Or launch the stand-alone Spyder program
...
<blockquote>Q1: Work through the <a href="https://docs.spyder-ide.org/current/videos/first-steps-with-spyder.html">First Steps with Spyder"</a> resources provided in the Spyder documentation. That includes two 3.5 minute videos that introduce you to the basics of the Spyder IDE and how to get started with Python in Spyder. Describe your experience learning to navigate Spyder using these resources.</blockquote>

<blockquote>Q2: How is Spyder different than other Python IDEs you have used? What do you see as strengths/advantages? What do you see as possible challenges?</blockquote>
...
62. If you have ever used a `print()` statement in your code to output a variable's value while the program is running, you have used a form of `logging` to debug your code.
...
Q1: Work through the <a href="https://docs.spyder-ide.org/current/videos/first-steps-with-spyder.html">First Steps with Spyder"</a> resources provided in the Spyder documentation. That includes two 3.5 minute videos that introduce you to the basics of the Spyder IDE and how to get started with Python in Spyder. Describe your experience learning to navigate Spyder using these resources.
